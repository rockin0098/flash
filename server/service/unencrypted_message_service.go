...
func (s *LProtoService) TL_req_pq_Process(sess *session.Session, tl *mtproto.TL_req_pq) (interface{}, error) {
	Log.Info("entering...")
	...
	resPQ := mtproto.New_TL_resPQ()
	resPQ.Set_nonce(nonce)
	resPQ.Set_server_nonce(crypto.GenerateNonce(16))
